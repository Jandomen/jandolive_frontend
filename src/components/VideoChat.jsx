  ...
  return (
    <div className="relative w-full h-[650px] flex flex-col items-center justify-center">
      {!mediaStarted && (
        <div className="flex flex-col gap-3 mb-6 text-center">
          ...
          <div className="flex gap-3 justify-center">
            ...
            <button
              onClick={() => handleStartMedia(false, false)}
              className="flex items-center gap-2 px-4 py-2 bg-gray-600 text-white rounded-lg hover:bg-gray-700 shadow-md"
            >
      ...
      <div
        ...
        style={{
          top: positions.current.local.y,
          left: positions.current.local.x,
        }}
      ...
      <div
        ...
        style={{
          top: positions.current.remote.y,
          left: positions.current.remote.x,
        }}
